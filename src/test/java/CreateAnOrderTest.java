import EndointsAndConstants.Endpoints;
import EndointsAndConstants.RandomUserData;
...
import static EndointsAndConstants.Endpoints.USER_DATA_ENDPOINT;
import static EndointsAndConstants.Endpoints.USER_ORDER_ENDPOINT;
...
public class CreateAnOrderTest {
    ...
    public Response createOrderWithoutToken() {
        response = given().headers("Content-type", "application/json").body(ingredient).post(USER_ORDER_ENDPOINT);
        return response;
    }
    ...
    public void createUser() {
        ...
        response = given().header("Content-type", "application/json").body(user).post(Endpoints.USER_REGISTRATION_ENDPOINT);
